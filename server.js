...
const app = express();
// const PORT = 5001; // Use port 5001 explicitly
const PORT = process.env.PORT || 5000;
...
const seedDB = async () => {
    const sampleProjects = [
        {
            logo: 'https://www.onlinelogomaker.com/blog/wp-content/uploads/2017/06/shopping-online.jpg',
            title: 'Ecommerce Website for Admin page with CRUD implementation',
            description: 'This is a website with an admin panel and admin login where the admin can manage all products.',
            linkText: 'View Project',
            link: 'https://github.com/Double-Script/first-project'
        },
        {
